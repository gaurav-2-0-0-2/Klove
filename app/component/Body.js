        ...
        <div className={`px-10 pt-20 h-[33rem] bg-white`}>
            <div className="flex">
                <div>
                    ...
                    <p className="w-[45%] pr-3 mt-6">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Et dignissimos neque sequi veniam earum error laudantium odit vel totam doloremque necessitatibus saepe dolorem voluptatem cupiditate aliquid laborum optio, debitis voluptate!</p>
