...
export default function Body() {
    return (
        <div className="px-10 pt-20 h-[33rem] bg-body-clr">
            <div className="flex justify-between">
                <div>
                    ...
                    <div className="flex gap-10 mt-16">
                        <button className=" bg-write-btn-clr text-xl font-extrabold px-8 py-2 rounded-md">WRITE</button>
                        <button className=" bg-post-btn-clr text-xl font-extrabold px-8 py-2 rounded-md">POST</button>
                    </div>
                </div>
